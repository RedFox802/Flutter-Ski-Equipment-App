...
/// @nodoc
class __$$_ReviewStateCopyWithImpl<$Res> extends _$ReviewStateCopyWithImpl<$Res>
    implements _$$_ReviewStateCopyWith<$Res> {
  __$$_ReviewStateCopyWithImpl(
      _$_ReviewState _value, $Res Function(_$_ReviewState) _then)
      : super(_value, (v) => _then(v as _$_ReviewState));

  @override
  _$_ReviewState get _value => super._value as _$_ReviewState;
...
class _$_ReviewState implements _ReviewState {
  ...
  @override
  String toString() {
    return 'ReviewState(loading: $loading, error: $error, ready: $ready)';
  }
...
abstract class _ReviewState implements ReviewState {
  const factory _ReviewState(
      {final bool loading,
      final bool error,
      final bool ready}) = _$_ReviewState;
